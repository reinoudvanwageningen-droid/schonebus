  ...
  return (
    <section className="px-4 py-16 sm:px-6 sm:py-20">
      <div className="mx-auto max-w-6xl">
        <h2 className="max-w-2xl font-display text-[32px] font-bold leading-tight tracking-[-0.02em] text-midnight sm:text-[38px]">
          ...
          {WHAT_WE_DO_ITEMS.map((item, index) => {
            ...
            return (
              <Card key={item.title} className="p-6 sm:p-7">
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-cloud text-electric">
